    ...
    <div class="create_modal-inner">
      ...
      <div class="create_modal-footer">
        <span class="create_modal-error">{{
          getErrorMainapplicationsCreate
        }}</span>
        <div class="create_modal-btn" @click="createAppeal">
          <DefaultButton
            :loader="getCanMainapplicationsCreate"
            :padding="'8px 16px'"
            :border-radius="'2px'"
            :style="'width:100%'"
          >
...
export default Vue.extend({
  ...
  methods: {
    ...mapMutations(["setErrorMainapplicationsCreate"]),
    ...mapActions(["mainapplicationsCreateAction"]),
    createAppeal(): void {
      this.mainapplicationsCreateAction({
    ...
    updateData(data: ApplicationData): void {
      this.formData = data;
      this.setErrorMainapplicationsCreate('')
    },
